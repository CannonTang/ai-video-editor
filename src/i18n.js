...
const EFFECTS_COPY_EN = {
  ...
  effectInDevelopment: "In development",
  ...
  effectVectorTrackingHint: "Compare displacement as people become motion vectors.",
  effectSwayMotion: "Sway motion",
  effectSwayMotionHint: "Add rhythmic side-to-side movement.",
...
const EFFECTS_WORKSPACE_COPY = {
  ...
  zh: {
    ...
    effectVectorTrackingHint: "将人物位移转化为可视化运动矢量。",
    effectSwayMotion: "摇摆动效",
    effectSwayMotionHint: "添加有节奏的左右摇摆运动。",
  ...
  ja: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.ja, personEffects: "人物エフェクト", backgroundEffects: "背景エフェクト", effectProperties: "エフェクト設定" },
  ko: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.ko, personEffects: "인물 효과", backgroundEffects: "배경 효과", effectProperties: "효과 속성" },
  es: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.es, personEffects: "Efectos de persona", backgroundEffects: "Efectos de fondo", effectProperties: "Propiedades del efecto" },
  fr: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.fr, personEffects: "Effets de personne", backgroundEffects: "Effets d’arrière-plan", effectProperties: "Propriétés de l’effet" },
  de: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.de, personEffects: "Personeneffekte", backgroundEffects: "Hintergrundeffekte", effectProperties: "Effekteigenschaften" },
  pt: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.pt, personEffects: "Efeitos de pessoa", backgroundEffects: "Efeitos de fundo", effectProperties: "Propriedades do efeito" },
  th: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.th, personEffects: "เอฟเฟกต์บุคคล", backgroundEffects: "เอฟเฟกต์พื้นหลัง", effectProperties: "คุณสมบัติเอฟเฟกต์" },
  vi: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.vi, personEffects: "Hiệu ứng người", backgroundEffects: "Hiệu ứng nền", effectProperties: "Thuộc tính hiệu ứng" },
  ru: { ...EFFECTS_COPY_EN, ...EFFECTS_LOCALIZED_COPY.ru, personEffects: "Эффекты человека", backgroundEffects: "Эффекты фона", effectProperties: "Параметры эффекта" },
};
...
export function createTranslator(languageId) {
  ...
  const specializedCopy = Object.assign({}, ...[
    EXPORT_RENDER_COPY, MEDIA_COMPATIBILITY_COPY, COMMUNITY_LINKS_COPY, TIMELINE_SELECTION_COPY, FACE_SWAP_COPY, VECTOR_LIBRARY_COPY, PROJECT_CHROME_COPY, CORE_LABEL_COPY, MOBILE_DRAWER_COPY, MOBILE_CLIP_ACTION_COPY,
