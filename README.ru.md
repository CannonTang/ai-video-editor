...
- **12 августа 2026 — Цветовые круги на компьютере:** добавлены круги для теней, средних тонов, светов и смещения, а также температура, оттенок и насыщенность. Все 15 параметров поддерживают ключевые кадры и одинаковый результат в предпросмотре и экспорте.
- **7 августа 2026 — Кроссплатформенный Agent Skill v0.9.2:** добавлены реконструкция референсного видео, построение акцентов и напряжения, рекламная драматургия, поиск материалов, маршрутизация локальных моделей, настройка зависимостей, подготовка китайской и английской озвучки и проверка аудио.
- **5 августа 2026 — Agent Skill v0.9.1:** опубликован профессиональный процесс автоматического монтажа с мультимодальным планированием, стабилизацией, трекингом, переносимой пофразовой озвучкой и совместной выдачей проверенного проекта `.timeline` и готового видео.
- **31 июля 2026 — Замена лица:** личность в выбранном видеоклипе можно заменить с помощью локального обнаружения лица, трекинга и предпросмотра в браузере.
